...
### Acknowledgment
Code is built on [LLaVA-NeXT](https://github.com/LLaVA-VL/LLaVA-NeXT), [diffusers](https://github.com/huggingface/diffusers), and [PixArt-a](https://github.com/PixArt-alpha/PixArt-alpha).
